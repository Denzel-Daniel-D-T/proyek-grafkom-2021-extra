...
namespace LearnOpenTK.Common
{
    ...
    public class Texture
    {
        ...
        private TexTarget selectedMode;
        ...
        public static Texture LoadFromFile(string path)
        {
            ...
            return new Texture(handle, TexTarget.Texture2D);
        }
        ...
        public static Texture LoadFromFile(List<string> imagePaths)
        {
            ...
            return new Texture(handle, TexTarget.CubeMap);
        }


        public Texture(int glHandle, TexTarget texTarget)
        {
            Handle = glHandle;
            selectedMode = texTarget;
        }
